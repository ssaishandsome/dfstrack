...
cfg.MODEL.DFS = edict()
cfg.MODEL.DFS.ENABLED = True
cfg.MODEL.DFS.NUM_SLOTS = 4
cfg.MODEL.DFS.NUM_STABLE_SLOTS = 2
cfg.MODEL.DFS.SLOT_TEMPERATURE = 0.5
cfg.MODEL.DFS.NUM_HEADS = 8
cfg.MODEL.DFS.ATTN_DROPOUT = 0.0
cfg.MODEL.DFS.PROJ_DROPOUT = 0.0
cfg.MODEL.DFS.TARGET_RADIUS = 0
cfg.MODEL.DFS.CONTEXT_RADIUS = 1
cfg.MODEL.DFS.RELIABILITY_HIDDEN_DIM = 256
cfg.MODEL.DFS.FUSION_HIDDEN_DIM = 256
cfg.MODEL.DFS.STABLE_ALPHA = 0.8
cfg.MODEL.DFS.ADAPTIVE_ALPHA = 0.4
cfg.MODEL.DFS.USE_FIXED_ALPHA = True
...
cfg.TRAIN.SLOT_DIV_WEIGHT = 0.1
cfg.TRAIN.SLOT_ORTH_WEIGHT = 0.1
cfg.TRAIN.SLOT_BAL_WEIGHT = 0.05
...
cfg.DATA.MULTI_MODAL_VISION = False
