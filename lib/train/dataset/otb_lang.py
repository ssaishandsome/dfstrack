...
class OTB_Lang(BaseVideoDataset):
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        subject_mask_infor = self.get_subject_mask_infor(seq_id)

        nlp_with_mask = exp_str + "+" + ",".join(map(str, subject_mask_infor))
        ...
        object_meta = OrderedDict({'object_class_name': None,
                                   ...
                                   'motion_adverb': None,
                                   'exp_str': exp_str,
                                   "subject_mask_infor":subject_mask_infor})
    ...
    def _get_sequence_info_list_train(self):
        sequence_info_list = [
            ...
            {"name": "Ironman", "path": "Ironman/img", "startFrame": 1, "endFrame": 166, "nz": 4, "ext": "jpg",
             ...
             "object_class": "person head"},
            {"name": "Jogging1", "path": "Jogging2/img", "startFrame": 1, "endFrame": 307, "nz": 4, "ext": "jpg",
             "anno_path": "Jogging2/groundtruth_rect.1.txt",
             "object_class": "person"},
            {"name": "Jogging2", "path": "Jogging2/img", "startFrame": 1, "endFrame": 307, "nz": 4, "ext": "jpg",
             "anno_path": "Jogging2/groundtruth_rect.2.txt",
             "object_class": "person"},
    ...
    def get_path(self, seq_id, frame_ids):
        ...
        for f_id in frame_ids:
            frame_id = f_id + start_frame
            frame_list.append(self._get_frame_path(seq_path, frame_id))
        return frame_list